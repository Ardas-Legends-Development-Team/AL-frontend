<template>
  <div class="flex flex-row justify-evenly my-8">
    <UserDashboardCard
      ...
      :source="cardsData.gear.sourceGood"
      :alt="cardsData.gear.altGood"
    />
    <UserDashboardActions class="-translate-y-48" />
    <UserDashboardCard
      :title="cardsData.pvpStatus.title"
      :description="cardsData.pvpStatus.description"
      :source="cardsData.pvpStatus.sourceGood"
      :alt="cardsData.pvpStatus.altGood"
    />
  </div>
</template>
